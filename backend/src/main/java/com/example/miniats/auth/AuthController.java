...
import com.example.miniats.auth.dto.LoginRequest;
import com.example.miniats.auth.dto.LoginResponse;
import com.example.miniats.auth.dto.MeResponse;
...
public class AuthController {
    ...
    public ApiResponse<MeResponse> me(Authentication authentication) {
        return ApiResponse.ok(new MeResponse(authentication.getName(), "管理员"));
    }
}
